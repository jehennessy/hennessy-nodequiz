...
let QuizComponent = class QuizComponent {
    constructor(route, http, cookieService, location, dialog) {
        this.route = route;
        this.http = http;
        this.cookieService = cookieService;
    ...
    onSubmit(form) {
        ...
        */
        ...
        const dialogRef = this.dialog.open(_quiz_result_dialog_quiz_result_dialog_component__WEBPACK_IMPORTED_MODULE_5__["QuizResultDialogComponent"], {
            data: {
...
module.exports = __webpack_require__(/*! /Users/jordanhennessy/bu-webdev/web-450/nodequiz/src/main.ts */"./src/main.ts");
