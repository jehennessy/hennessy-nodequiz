...
let QuizResultDialogComponent = class QuizResultDialogComponent {
...
QuizResultDialogComponent.ctorParameters = () => [
...
let QuizComponent = class QuizComponent {
    ...
    onSubmit(form) {
        ...
        const dialogRef = this.dialog.open(_quiz_result_dialog_quiz_result_dialog_component__WEBPACK_IMPORTED_MODULE_6__["QuizResultDialogComponent"], {
            data: {
